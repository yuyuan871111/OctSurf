...
class Octree : public OctreeParser {
 public:
  ...
  void set_octree(const char* data, const int sz);                              // qq: TODO: int to long
  void set_octree(const char* data, const int64_t sz);
  void resize_octree(const int sz);                                             // qq: TODO: int to long
  void resize_octree(const int64_t sz);
 ...
 protected:
  ...
  void serialize(Dtype* des, const vector<vector<Dtype> >& src, const int location);            // qq: TODO: int to long
