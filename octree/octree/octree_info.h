...
class OctreeInfo {
 ...
 public:
  ...
  int locations(PropType ptype) const;                        // qq: -1 or d, or 0
  int64_t ptr_dis(PropType ptype, const int depth) const;  //int ptr_dis(PropType ptype, const int depth) const;        // qq: TODO: long
  ...
  int64_t sizeof_octree() const { return ptr_dis_[kPTypeNum]; } // qq: TODO: long
 ...
 private:
  int64_t ptr_dis_[16];  //int ptr_dis_[16]; // qq: what is this used for? // qq: TODO: long
};
